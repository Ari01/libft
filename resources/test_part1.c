...
/*   Updated: 2020/12/02 04:18:29 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_strnstr(const char *big, const char *little, size_t len)
{
	...
	{
		printf("man or ft null but not both \n");
		printf("test ko\n\n");
	}
}
...
int		main(void)
{
	...
	test_strnstr("Hello wwworld", "world", 20);
	test_strnstr("Hello wwworld", "wld", 20);
	test_strnstr("Hello world", "hello", 2);
	test_strnstr("Hello world", "hello worl", 20);
	test_strnstr("Hello worl", "hellow world", 20);
	test_strnstr("", "", 20);
	test_strnstr("", "hello", 20);
	test_strnstr("hello", "", 20);
	test_strnstr(NULL, "", 20);
	test_strnstr(NULL, "", 0);
	...
	test_atoi(" -+-+2147483648");
	test_atoi("2147483647 ");
	test_atoi("-214879878979465");
	test_atoi("214748364855");
	test_atoi("");
